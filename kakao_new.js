...
function getListItem(index, places) {
    ...
    itemStr = '<div class="info">' +
                '   <h5 style="font-size: 18px;">'+ "지점명 : " + places.place_name + '</h5>';

    if (places.road_address_name) {
        itemStr += '    <span style="font-size: 15px;" >' + "주소 : " + places.road_address_name + '</span><br>';
    } else {
        itemStr += '    <span>' + "주소 : " + places.address_name  + '</span><br>'; 
    }
                 
      itemStr += '  <span style="font-size: 15px;" >' + "전화번호 : " + places.phone  + '</span><br>' +
                '</div>';           
